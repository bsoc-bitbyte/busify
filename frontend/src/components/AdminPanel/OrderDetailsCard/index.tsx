...
export default function OrderDetailsCard({active, details, showModal }: RecentOrderCardProps) {
    const theme = useTheme();
    return (
        <Box height="100vh" width="100%" justifyContent="center" alignItems="center" position="fixed" top={0} left={0} zIndex={100} display={active ? "flex" : "none"} sx={{backdropFilter: "blur(8px)"}} 
        >
            <Card sx={{width: "95%", maxWidth: "550px", padding: "2rem", borderRadius: "16px"}}>
                <Box width="100%" display="flex" justifyContent="end" marginBottom="1.5rem">
                    <Clear
                        htmlColor={theme.palette.primary.main}
                        sx={{ fontSize: '1.2rem', backgroundColor: "#FFF1C7", borderRadius: "100%" }}
